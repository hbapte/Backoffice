  ...
  test("POST /inventories", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastRestockedDate: CREATE_RESULT.lastRestockedDate.toISOString(),
      ...
      .expect([
        {
          ...
          lastRestockedDate:
            FIND_MANY_RESULT[0].lastRestockedDate.toISOString(),
  ...
  test("GET /inventories/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastRestockedDate: FIND_ONE_RESULT.lastRestockedDate.toISOString(),
